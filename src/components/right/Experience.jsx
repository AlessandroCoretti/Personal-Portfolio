      ...
      <ol>
        {experiences.map((exp, index) => (
          <li key={index} className="mb-12">
            <a href={t(exp.link)} target="_blank" rel="noopener noreferrer" className="block group">
              <div className="grid grid-cols-8  !items-top hover:bg-slate-800/50 hover:p-2 hover:rounded hover:scale-[1.05] transition-all duration-300 easein-out ">
                ...
                <div className="col-span-8 lg:col-span-6">
                  <div className="flex items-center text-slate-200 font-bold text-lg gap-2 cursor-pointer group-hover:text-emerald-300 duration-200 ese-in">
                    <h3>{t(exp.role)}</h3>
